...
class Edo_dashboard extends CI_Controller
{
	...
	function index()
	{
		...
		$this->load->view('EDO/Edo_dashboard');
	...
	function get_all_proposals()
	{
		...
		$result['details'] = $this->edo_model->get_all_proposals($sent_by);

		$this->load->view('includes/header');
		$this->load->view('EDO/list_of_proposal', $result);
		$this->load->view('includes/footer');
	}
	...
	function Save_Proposal_Status()
	{
		...
		$result = $this->edo_model->Save_Prop_Status($data, $proposal_id, $comment);
	...
	function Save_Proposal_Comment()
	{
		...
		$result = $this->edo_model->Save_Prop_Comment($data, $comment);
		if($result == true)
		{
