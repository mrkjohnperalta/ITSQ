                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit bordered calendar">
                        <div class="portlet-title">
                            ...
                            <a href="<?= base_url(). 'RO/Dashboard'?>" class="btn green pull-right">Go Back</a>
                        </div>
                        <div class="portlet-body">
                        <?php echo form_open('RO/Dashboard/change_status');?>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th> Room Number </th>
                                            <th width="11%"> Date Needed </th>
                                                    ...
                                                    <tr>
                                                        <td> <div class="mt-checkbox-list">
                                                                <label class="mt-checkbox mt-checkbox-outline"> <?= $room['room_number'] ?>
                                                                    <input type="checkbox" id="checkBoxID" name="reservationID[]" value="<?= $room['room_reserve_id'] ?>">
                                                                    <span></span>
                                                                </label>
                                                            </div>  </td>
                                                        <td> <?= $room['date_reserved'] ?> </td>
                                                        <td> <?= $room['date_end'] ?> </td>
                                                        <td> <?= $room['time_start'] ?> </td>
                                                        <td> <?= $room['time_end'] ?> </td>
                                                        <td> <?= $room['reservation_name'] ?> </td>
