                        ...
                        <div class="portlet-body">
                            ...
                            <?php
                                foreach($details as $list)
                                {
                                    ...
                                    if($list['accounting_status'] == 1 || $list['accounting_status'] == 2)
                                    {
                            ?>
                                                                ...
                                                                <div class='mt-element-step'>
                                                                    <div class='row step-line'>
                                                                        <div class='col-md-2 mt-step-col first done'>
                                                                            ...
                                                                            <div class='mt-step-content font-grey-cascade uppercase'>APPROVED</div>
                                                                        </div>
                                                                        ...
                                                                        <div id="icon_status<?php echo $list['prop_id'] ?>" class='col-md-2 mt-step-col <?= $ao_status ?>'>
                                                                            ...
                                                                            <select class='form-control input-sm' id='status<?php echo $list['prop_id'] ?>' style='text-align-last:center;' onchange='getvalue<?php echo $list['prop_id'] ?>(this);'>
                                                                                <option value='<?=$list['accounting_status']?>'><?= $ao_text ?></option>
