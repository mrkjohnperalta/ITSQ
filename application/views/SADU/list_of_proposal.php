                        ...
                        <div class="portlet-body">
                            ...
                            <?php
                                foreach($details as $list)
                                {
                                    ...
                                    if($list['sadu_status'] == 1 || $list['sadu_status'] == 2)
                                    {
                            ?>
                                                            ...
                                                            <div class='tab-content'>
                                                                ...
                                                                <div class='mt-element-step'>
                                                                    <div class='row step-line'>
                                                                        ...
                                                                        <div id="icon_status<?php echo $list['prop_id'] ?>" class='col-md-2 mt-step-col <?= $sadu_status ?>'>
                                                                            ...
                                                                            <select class='form-control input-sm' id='status<?php echo $list['prop_id'] ?>' style='text-align-last:center;' onchange='getvalue<?php echo $list['prop_id'] ?>(this);'>"+
                                                                                <option value='<?=$list['sadu_status']?>'><?= $sadu_text ?></option>
